...
},{"core-js/library/fn/object/create":6}],3:[function(require,module,exports){
...
},{"babel-runtime/core-js/symbol":3}],5:[function(require,module,exports){
require('../../modules/es6.string.iterator');
require('../../modules/es6.array.from');
module.exports = require('../../modules/$.core').Array.from;
},{"../../modules/$.core":12,"../../modules/es6.array.from":47,"../../modules/es6.string.iterator":49}],6:[function(require,module,exports){
var $ = require('../../modules/$');
module.exports = function create(P, D){
  return $.create(P, D);
};
},{"../../modules/$":32}],7:[function(require,module,exports){
require('../../modules/es6.symbol');
require('../../modules/es6.object.to-string');
module.exports = require('../../modules/$.core').Symbol;
},{"../../modules/$.core":12,"../../modules/es6.object.to-string":48,"../../modules/es6.symbol":50}],8:[function(require,module,exports){
...
},{"./$.cof":11,"./$.wks":45}],11:[function(require,module,exports){
...
},{"./$":32}],17:[function(require,module,exports){
...
},{"./$":32,"./$.to-iobject":41}],20:[function(require,module,exports){
...
},{"./$":32,"./$.descriptors":15,"./$.property-desc":35}],23:[function(require,module,exports){
// fallback for non-array-like ES3 and non-enumerable old V8 strings
var cof = require('./$.cof');
module.exports = Object('z').propertyIsEnumerable(0) ? Object : function(it){
  return cof(it) == 'String' ? it.split('') : Object(it);
};
},{"./$.cof":11}],24:[function(require,module,exports){
...
},{"./$.iterators":31,"./$.wks":45}],25:[function(require,module,exports){
...
},{"./$.an-object":9}],28:[function(require,module,exports){
'use strict';
var $              = require('./$')
...
},{"./$":32,"./$.hide":22,"./$.property-desc":35,"./$.set-to-string-tag":37,"./$.wks":45}],29:[function(require,module,exports){
'use strict';
...
},{"./$":32,"./$.export":17,"./$.has":21,"./$.hide":22,"./$.iter-create":28,"./$.iterators":31,"./$.library":34,"./$.redefine":36,"./$.set-to-string-tag":37,"./$.wks":45}],30:[function(require,module,exports){
...
},{"./$.wks":45}],31:[function(require,module,exports){
module.exports = {};
...
},{"./$":32,"./$.to-iobject":41}],34:[function(require,module,exports){
module.exports = true;
...
},{"./$.hide":22}],37:[function(require,module,exports){
...
},{"./$":32,"./$.has":21,"./$.wks":45}],38:[function(require,module,exports){
var global = require('./$.global')
...
},{"./$.global":20}],39:[function(require,module,exports){
...
},{"./$.defined":14,"./$.iobject":23}],42:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./$.to-integer')
  , min       = Math.min;
module.exports = function(it){
...
},{"./$.defined":14}],44:[function(require,module,exports){
var id = 0
  , px = Math.random();
module.exports = function(key){
...
},{"./$.global":20,"./$.shared":38,"./$.uid":44}],46:[function(require,module,exports){
...
},{"./$.classof":10,"./$.core":12,"./$.iterators":31,"./$.wks":45}],47:[function(require,module,exports){
'use strict';
var ctx         = require('./$.ctx')
  , $export     = require('./$.export')
...
},{"./$.ctx":13,"./$.export":17,"./$.is-array-iter":24,"./$.iter-call":27,"./$.iter-detect":30,"./$.to-length":42,"./$.to-object":43,"./core.get-iterator-method":46}],48:[function(require,module,exports){
...
},{"./$.iter-define":29,"./$.string-at":39}],50:[function(require,module,exports){
'use strict';
...
},{"./$":32,"./$.an-object":9,"./$.descriptors":15,"./$.enum-keys":16,"./$.export":17,"./$.fails":18,"./$.get-names":19,"./$.global":20,"./$.has":21,"./$.is-array":25,"./$.keyof":33,"./$.library":34,"./$.property-desc":35,"./$.redefine":36,"./$.set-to-string-tag":37,"./$.shared":38,"./$.to-iobject":41,"./$.uid":44,"./$.wks":45}],51:[function(require,module,exports){
(function (global){
/**
 * @license
...
if ((0, _lodash.isUndefined)(window.angular)) {
    throw new _error2.default('Could not find angular. Please make sure to include angular before including edm-angular.js.');
}

// Add angular-specific configs
_config2.default.autoFactories = false;
_config2.default.prototype.setAutoFactories = setAutoFactories;

function setAutoFactories(bool) {
    if (!(0, _lodash.isBoolean)(bool)) {
        throw new _error2.default('setAutoFactories() expects argument to be of type boolean, got \'{0}\' ({1})', bool, typeof bool === 'undefined' ? 'undefined' : (0, _typeof3.default)(bool));
    }

    this.autoFactories = bool;
};

},{"./config":53,"./error":54,"babel-runtime/helpers/typeof":4,"lodash":51}],53:[function(require,module,exports){
'use strict';
...
},{"../error":54,"babel-runtime/helpers/typeof":4,"lodash":51}],54:[function(require,module,exports){
'use strict';
...
},{"babel-runtime/core-js/array/from":1,"babel-runtime/core-js/object/create":2}]},{},[52])


//# sourceMappingURL=edm-angular.js.map
